  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
      <Card className="p-4 border-border/70 shadow-2xs">
        ...
        <span className="text-[11px] text-muted-foreground">Pending triage</span>
      </Card>
      ...
      <Card className="p-4 border-border/70 shadow-2xs">
        ...
        <span className="text-[11px] text-amber-600 font-medium">Document verification</span>
      </Card>
      ...
      <Card className="p-4 border-border/70 shadow-2xs">
        ...
        <span className="text-[11px] text-purple-600 font-medium">Scheduled this week</span>
      </Card>
      ...
      <Card className="p-4 border-border/70 shadow-2xs">
        ...
        <span className="text-[11px] text-emerald-600 font-medium">Ready for cohort enroll</span>
      </Card>
    </div>
  );
}
