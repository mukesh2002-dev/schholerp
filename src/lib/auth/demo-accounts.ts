...
/**
 * Staff roles allowed on the admin login page.
 * Student / Teacher portals are intentionally excluded —
 * they will get a separate login experience in future.
 */
export type StaffRole = "SUPER_ADMIN" | "PRINCIPAL" | "ACCOUNTANT" | "HR_MANAGER";
