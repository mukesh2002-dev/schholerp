...
export const initialSalaryStructures: SalaryStructure[] = [
  {
    id: "ss-001", name: "PGT", description: "For senior faculty with 8+ years experience",
  ...
  {
    id: "ss-002", name: "TGT", description: "For teaching staff with 0-5 years experience",
...
export const initialPayrollRecords: PayrollRecord[] = [
  { id: "pay-001", employeeId: "tch-01", employeeName: "Mrs. Sunita Rao", employeeRole: "PGT", employeeAvatar: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=100", branchId: "br-apex-01", branchName: "Apex Global Campus", salaryStructureId: "ss-001", salaryStructureName: "PGT", month: "August", year: 2026, workingDays: 25, presentDays: 24, baseSalary: 65000, allowances: [{ name: "HRA", amount: 15000 }, { name: "Conveyance", amount: 3000 }, { name: "Medical", amount: 2500 }], grossSalary: 85500, deductions: [{ name: "PF", amount: 7800 }, { name: "Professional Tax", amount: 200 }, { name: "Income Tax", amount: 8500 }], totalDeductions: 16500, netSalary: 69000, status: "PAID", paymentDate: "2026-08-31", paymentMode: "BANK_TRANSFER", transactionId: "TXN-SAL-2026-0801", createdAt: "2026-08-28T10:00:00Z", updatedAt: "2026-08-31T10:00:00Z" },
  { id: "pay-002", employeeId: "tch-02", employeeName: "Mr. Rajesh Kulkarni", employeeRole: "PGT", branchId: "br-apex-01", branchName: "Apex Global Campus", salaryStructureId: "ss-001", salaryStructureName: "PGT", month: "August", year: 2026, workingDays: 25, presentDays: 25, baseSalary: 65000, allowances: [{ name: "HRA", amount: 15000 }, { name: "Conveyance", amount: 3000 }, { name: "Medical", amount: 2500 }], grossSalary: 85500, deductions: [{ name: "PF", amount: 7800 }, { name: "Professional Tax", amount: 200 }, { name: "Income Tax", amount: 7200 }], totalDeductions: 15200, netSalary: 70300, status: "PAID", paymentDate: "2026-08-31", paymentMode: "BANK_TRANSFER", transactionId: "TXN-SAL-2026-0802", createdAt: "2026-08-28T10:00:00Z", updatedAt: "2026-08-31T10:00:00Z" },
  { id: "pay-003", employeeId: "tch-03", employeeName: "Ms. Priya Menon", employeeRole: "TGT", branchId: "br-west-02", branchName: "Westside STEM & Innovation Academy", salaryStructureId: "ss-002", salaryStructureName: "TGT", month: "August", year: 2026, workingDays: 25, presentDays: 23, baseSalary: 40000, allowances: [{ name: "HRA", amount: 10000 }, { name: "Conveyance", amount: 2000 }, { name: "Medical", amount: 1500 }], grossSalary: 53500, deductions: [{ name: "PF", amount: 4800 }, { name: "Professional Tax", amount: 200 }], totalDeductions: 5000, netSalary: 48500, status: "PAID", paymentDate: "2026-08-31", paymentMode: "BANK_TRANSFER", transactionId: "TXN-SAL-2026-0803", createdAt: "2026-08-28T10:00:00Z", updatedAt: "2026-08-31T10:00:00Z" },
  { id: "pay-004", employeeId: "tch-05", employeeName: "Mrs. Kavitha Subramaniam", employeeRole: "PGT", branchId: "br-apex-01", branchName: "Apex Global Campus", salaryStructureId: "ss-001", salaryStructureName: "PGT", month: "August", year: 2026, workingDays: 25, presentDays: 22, baseSalary: 65000, allowances: [{ name: "HRA", amount: 15000 }, { name: "Conveyance", amount: 3000 }, { name: "Medical", amount: 2500 }], grossSalary: 85500, deductions: [{ name: "PF", amount: 7800 }, { name: "Professional Tax", amount: 200 }, { name: "Income Tax", amount: 9000 }], totalDeductions: 17000, netSalary: 68500, status: "PAID", paymentDate: "2026-08-31", paymentMode: "BANK_TRANSFER", transactionId: "TXN-SAL-2026-0804", createdAt: "2026-08-28T10:00:00Z", updatedAt: "2026-08-31T10:00:00Z" },
  { id: "pay-005", employeeId: "tch-06", employeeName: "Ms. Neha Kapoor", employeeRole: "TGT", branchId: "br-apex-01", branchName: "Apex Global Campus", salaryStructureId: "ss-002", salaryStructureName: "TGT", month: "August", year: 2026, workingDays: 25, presentDays: 25, baseSalary: 40000, allowances: [{ name: "HRA", amount: 10000 }, { name: "Conveyance", amount: 2000 }, { name: "Medical", amount: 1500 }], grossSalary: 53500, deductions: [{ name: "PF", amount: 4800 }, { name: "Professional Tax", amount: 200 }], totalDeductions: 5000, netSalary: 48500, status: "PAID", paymentDate: "2026-08-31", paymentMode: "BANK_TRANSFER", transactionId: "TXN-SAL-2026-0805", createdAt: "2026-08-28T10:00:00Z", updatedAt: "2026-08-31T10:00:00Z" },
  ...
  { id: "pay-007", employeeId: "tch-01", employeeName: "Mrs. Sunita Rao", employeeRole: "PGT", employeeAvatar: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=100", branchId: "br-apex-01", branchName: "Apex Global Campus", salaryStructureId: "ss-001", salaryStructureName: "PGT", month: "September", year: 2026, workingDays: 24, presentDays: 24, baseSalary: 65000, allowances: [{ name: "HRA", amount: 15000 }, { name: "Conveyance", amount: 3000 }, { name: "Medical", amount: 2500 }], grossSalary: 85500, deductions: [{ name: "PF", amount: 7800 }, { name: "Professional Tax", amount: 200 }, { name: "Income Tax", amount: 8500 }], totalDeductions: 16500, netSalary: 69000, status: "PROCESSING", createdAt: "2026-09-28T10:00:00Z", updatedAt: "2026-09-28T10:00:00Z" },
  { id: "pay-008", employeeId: "tch-02", employeeName: "Mr. Rajesh Kulkarni", employeeRole: "PGT", branchId: "br-apex-01", branchName: "Apex Global Campus", salaryStructureId: "ss-001", salaryStructureName: "PGT", month: "September", year: 2026, workingDays: 24, presentDays: 24, baseSalary: 65000, allowances: [{ name: "HRA", amount: 15000 }, { name: "Conveyance", amount: 3000 }, { name: "Medical", amount: 2500 }], grossSalary: 85500, deductions: [{ name: "PF", amount: 7800 }, { name: "Professional Tax", amount: 200 }, { name: "Income Tax", amount: 7200 }], totalDeductions: 15200, netSalary: 70300, status: "DRAFT", createdAt: "2026-09-28T10:00:00Z", updatedAt: "2026-09-28T10:00:00Z" },
];
