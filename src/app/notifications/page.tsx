      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs sm:text-sm text-muted-foreground mt-1">
            View and manage your notifications and delivery preferences.
          </p>
        </div>
      ...
      <Tabs defaultValue="all">
        <TabsList>
          ...
          <TabsTrigger value="unread" className="gap-1.5">
            ...
            Unread
            {unreadCount > 0 && (
              <span className="ml-1 rounded-full bg-primary text-primary-foreground text-[10px] h-4 min-w-4 flex items-center justify-center px-1">
                {unreadCount}
              </span>
            )}
          </TabsTrigger>
