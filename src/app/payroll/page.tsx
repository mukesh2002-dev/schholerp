...
import { PayrollRecord, SalaryStructure, PayrollStatus } from "@/types";
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <Button variant="gradient" className="gap-2 shrink-0" onClick={() => toast.info("Generate Payroll — demo placeholder", { description: "Automated payroll generation for August 2026 is coming soon." })}>
